export const testimonialsData = [
    {
        id: 1,
        number: <div>
            <span className='text-3xl font-bold text-primary'>2.3 x</span>
            <span className='block text-sm text-muted-foreground mt-1'>Increase in<br/>Conversion Rate</span>
        </div>,
    ...
    },
    {
        ...
        number: <div>
            ...
            <span className='block text-sm text-muted-foreground mt-1'>Growth in<br/>User Engagement</span>
        </div>,
    ...
    },
    {
        ...
        number: <div>
            ...
            <span className='block text-sm text-muted-foreground mt-1'>Client Satisfaction<br/>Rate</span>
        </div>,
    ...
    },
    {
        ...
        number: <div>
            ...
            <span className='block text-sm text-muted-foreground mt-1'>Reduction in<br/>Bounce Rate</span>
        </div>,
